...
manager.addAnswer('en', 'badword', 'Woah! Dial it down, keyboard warrior 🧘');
...
function getFunnyFallback() {
    const lines = [
        "I don't speak alien yet. Try again, Earthling 🛸",
        "I'm not Google, but I still expected a better question.",
        "I just small bot, i only know this website related knowledge ",
        "That question just gave me an existential crisis.",
        "You're making me question your sanity... and mine."
    ];
